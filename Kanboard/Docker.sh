...
###########################################################################
# This script will download and install Docker which needed for Minikube. #
# The script will then execute a Minikube script to build an AWX cluster. #
###########################################################################
...
service() {
 ...
 |____/ \___/ \___|_|\_\___|_|  
    ...
    echo -e "\e[38;5;208;1;3m[INFO] Executing Minikube script...\e[m"
}
